...
from utils.yuyv2rgb import bgr2yuyv, yuyv2rgb, rgb2yuyv
    ...
    try:
        ...
        if os.path.isfile(lb_file):
            ...
            if nl:
                ...
                # assert (lb[:, 1:] <= 1).all(), f'non-normalized or out of bounds coordinates {lb[:, 1:][lb[:, 1:] > 1]}' # it's ok to be a bit out of bound
